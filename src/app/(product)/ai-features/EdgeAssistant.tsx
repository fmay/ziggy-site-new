...
const EdgeAssistant: FC<JavascriptFeaturesProps> = ({}) => {
  const items: ReactNode[] = [
    <StackCard
      ...
      ctaNewTab
      graphic="/product/edge-assistant/aie-flow.webp"
    ...
    <StackCard
      ...
      ctaHref="https://docs.ziggyservices.com/user-guide/AI-Edge-Assistant"
      ctaNewTab
      graphic="/product/edge-assistant/aie-assistant.webp"
      graphicBgColor="bg-flow-gray"
    />,
    <StackCard
      title="Validations"
      ...
      ctaHref="https://docs.ziggyservices.com/user-guide/AI-Edge-Assistant"
      ctaNewTab
      graphic="/product/edge-assistant/aie-failed.webp"
      graphicBgColor="bg-flow-gray"
    />,
    <StackCard
      title="Output"
      ...
      ctaHref="https://docs.ziggyservices.com/user-guide/AI-Edge-Assistant"
      ctaNewTab
      graphic="/product/edge-assistant/aie-data-out.webp"
      graphicBgColor="bg-flow-gray"
    />,
  ]
  ...
  return (
    <div>
      <div id="javascript" className="section-intro">
        ...
        <p>
          AI is never applied at run time. It generates hidden code in the designer, so it is fast
          and 100% consistent.
        </p>
      </div>
